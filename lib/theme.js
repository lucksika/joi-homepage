...
const components = {
    Heading: {
        baseStyle: props => ({
            color: mode('#0D21A1', '#EEC643')(props)
        }),
        variants: {
            "title": props => ({
                color: mode("#0D21A1", "#EEC643")(props),
                textDecoration: 'underline',
                textDecorationColor: mode("#0D21A1", "#EEC643")(props),
    ...
    Button: {
        variants: {
            "outline": props => ({
                borderColor: mode("#0d21a1", "#EEC643")(props),
                color: mode("#0d21a1", "#EEC643")(props),
                _hover: {
                    bg: mode("#0d21a127", "#eec64345")(props)
                }
            }),
            "solid": props => ({
                color: "#ffffff",
                bg: mode("#0d21a1", "#D1AE3B")(props),
                _hover: {
